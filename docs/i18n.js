...
const I18N = {
  ...
  fr: {
    ...
    "nav.live_demo": "Démo en direct",
    "nav.lang_title": "Changer de langue",
    "hero.title": "Détectez les cartes Yu-Gi-Oh! en temps réel.",
    "hero.desc": "DRAW2 s'appuie sur une architecture de modèle à la pointe de la technologie, entraînée sur plus de 13 000 cartes, pour les reconnaître automatiquement en conditions réelles de duel, ce qu'aucun système précédent ne fait à cette échelle aujourd'hui.<br><br>Essayez la démo ci-dessous pour exécuter le modèle sur votre propre GPU en temps réel. Rien n'est envoyé ni stocké de notre côté.",
    "hero.cta_try": "Essayer maintenant !",
    ...
    "demo.waiting_input": "> En attente d'une entrée...",
  ...
  ja: {
    ...
    "hero.desc": "DRAW2は13,000枚以上のカードで学習した最新のモデルアーキテクチャにより、実際のデュエル環境下でもカードを自動認識します。これほどの規模でこれを実現したシステムは、これまでありませんでした。<br><br>下のデモから、お使いのGPUでリアルタイムにモデルを試せます。画像がアップロードされたり保存されたりすることは一切ありません。",
    "hero.cta_try": "今すぐ試す",
    ...
    "demo.console_label": "コンソール",
    "demo.executing": "実行中",
    "demo.waiting_input": "> 入力を待機中...",
